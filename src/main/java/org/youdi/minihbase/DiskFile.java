...
public class DiskFile implements Closeable {
  ...
  public static class BlockMeta implements Comparable<BlockMeta> {
    ...
    private org.youdi.minihbase.KeyValue lastKV;
     ...
     */
    private static BlockMeta createSeekDummy(org.youdi.minihbase.KeyValue lastKV) {
      return new BlockMeta(lastKV, 0L, 0L, Bytes.EMPTY_BYTES);
    }

    public BlockMeta(org.youdi.minihbase.KeyValue lastKV, long offset, long size, byte[] bloomFilter) {
      this.lastKV = lastKV;
    ...
    public org.youdi.minihbase.KeyValue getLastKV() {
      return this.lastKV;
    }
    ...
    public static BlockMeta parseFrom(byte[] buf, int offset) throws IOException {
      ...
      org.youdi.minihbase.KeyValue lastKV = org.youdi.minihbase.KeyValue.parseFrom(buf, offset);
  ...
  public static class BlockIndexWriter {
    ...
    public void append(org.youdi.minihbase.KeyValue lastKV, long offset, long size, byte[] bloomFilter) {
  ...
  public static class BlockWriter {
    ...
    private List<org.youdi.minihbase.KeyValue> kvBuf;
    ...
    public void append(org.youdi.minihbase.KeyValue kv) throws IOException {
  ...
  public static class BlockReader {
    ...
    public BlockReader(List<org.youdi.minihbase.KeyValue> kvBuf) {
      this.kvBuf = kvBuf;
    }

    public static BlockReader parseFrom(byte[] buffer, int offset, int size) throws IOException {
      int pos = 0;
      List<org.youdi.minihbase.KeyValue> kvBuf = new ArrayList<org.youdi.minihbase.KeyValue>();
      ...
      for (int i = 0; i < kvSize; i++) {
        org.youdi.minihbase.KeyValue kv = org.youdi.minihbase.KeyValue.parseFrom(buffer, offset + pos);
        kvBuf.add(kv);
    ...
    public List<org.youdi.minihbase.KeyValue> getKeyValues() {
      return kvBuf;
    }
  }
  ...
  private class InternalIterator implements SeekIter<org.youdi.minihbase.KeyValue> {
    ...
    @Override
    public void seekTo(org.youdi.minihbase.KeyValue target) throws IOException {
      ...
      if (blockMetaIter.hasNext()) {
        ...
        while (currentKVIndex < currentReader.getKeyValues().size()) {
          org.youdi.minihbase.KeyValue curKV = currentReader.getKeyValues().get(currentKVIndex);
  ...
  public SeekIter<org.youdi.minihbase.KeyValue> iterator() {
