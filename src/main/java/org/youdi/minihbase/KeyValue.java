...
public class KeyValue implements Comparable<KeyValue> {
    ...
    /**
     * key value进行序列化
     * 数据格式|rowkeylen|rowkey|valuelen|value|op|sequenceId|
     *
     * @return
     * @throws IOException
     */
...
//    |rowkeylen|rowkey|valuelen|value|op|sequenceId|
    ...
    /**
     * 进行对比大小 排序，优先级 key sequenceId op
     *
     * @param kv
     * @return
     */
