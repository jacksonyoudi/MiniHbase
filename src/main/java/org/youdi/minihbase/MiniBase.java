...
public interface MiniBase extends Closeable {
  ...
  org.youdi.minihbase.KeyValue get(byte[] key) throws IOException;
   ...
   */
  Iter<org.youdi.minihbase.KeyValue> scan(byte[] startKey, byte[] stopKey) throws IOException;
   ...
   * @throws IOException
   */
  default Iter<org.youdi.minihbase.KeyValue> scan() throws IOException {
  ...
  interface Flusher {
    void flush(Iter<org.youdi.minihbase.KeyValue> it) throws IOException;
  }
